...
export default function SubmissionPage() { // Renamed from SubmissionDetailsPage to SubmissionPage
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-start p-5 md:p-8 lg:p-12 bg-gray-100">
      <div className="w-full max-w-2xl bg-white p-6 md:p-8 rounded-lg shadow-md">
        <h1 className="text-2xl font-bold mb-6 text-center text-gray-800">Form Submission</h1> {/* Updated title */}
        ...
        {formData && (
          <div className="mb-6">
            <h2 className="text-xl font-semibold mb-3 text-gray-700">Submitted Data (JSON):</h2>
