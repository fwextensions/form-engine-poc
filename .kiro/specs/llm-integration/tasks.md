...
- [ ] 2. Implement LLM Client and Utilities
  ...
  - [ ] 2.2 Create YAML extractor in `form-editor/src/lib/yaml-extractor.ts`
  ...
  - [ ] 2.3 Write property tests for YAML extraction
    - **Property 8: YAML Extraction from Responses**
    - **Validates: Requirements 7.1, 7.2, 7.3**

  - [ ] 2.4 Create schema validator in `form-editor/src/lib/schema-validator.ts`
  ...
  - [ ] 2.6 Create settings storage in `form-editor/src/lib/settings.ts`
  ...
  - [ ] 2.7 Write property tests for settings round-trip
...
- [ ] 4. Implement Schema Generator Service
  - [ ] 4.1 Create SchemaGenerator class in `form-editor/src/lib/schema-generator.ts`
  ...
  - [ ] 4.2 Write property tests for schema generator
